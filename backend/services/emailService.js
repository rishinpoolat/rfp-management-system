...
BUDGET: ${
      rfpData.budget ? `$${parseFloat(rfpData.budget).toLocaleString()}` : "N/A"
    }
...
Procurement Team
    ...
    const mailOptions = {
      ...
      to: vendor.email,
      subject: `RFP: ${rfpData.title} - Response Requested by ${
        rfpData.deadline || "TBD"
      }`,
      text: emailBody,
    };
